---
title: "수능 영어 3등급 탈출! 고난도 어휘, 헷갈리는 동의어 확실히 구분하는 비법"
description: "수능 영어 3등급 학생들을 위한 고난도 어휘 및 헷갈리는 동의어 완벽 공략법. 실제 기출 지문과 예문을 통해 실전 문제 해결 능력을 키우세요."
category: "수능·내신"
tags: ["수능 영어", "영어 어휘", "동의어", "고난도 어휘", "3등급 탈출"]
date: "2026-07-30"
published: true
thumbnail: "/blog-images/suneung-english-difficult-vocab-synonym/1.png"
---
...
우리가 어디를 향하든 전능한 '사이버스페이스'에 대해 듣게 된다! 그 과대광고는 우리가 지루한 삶을 떠나 고글과 전신 슈트를 착용하고 금속성의, 3차원적이며, 멀티미디어로 이루어진 또 다른 세계로 들어갈 것이라고 약속한다. 산업혁명이 그 위대한 혁신인 모터와 함께 도래했을 때, 우리는 우리의 세계를 떠나 어떤 ①동떨어진 모터공간으로 가지 않았다! 오히려 우리는 자동차, 냉장고, 드릴 프레스, 연필깎이 등의 형태로 모터를 우리 삶 속으로 들여왔다. 이 ②흡수는 너무나 완전해서 우리는 이 모든 도구들을 그것의 '모터성'이 아니라 그 용도를 나타내는 이름으로 부른다. 이러한 혁신들이 주요한 사회경제적 운동으로 이어진 것은 정확히 그것들이 우리의 일상생활에 깊이 파고들어 ③영향을 미쳤기 때문이다. 사람들은 수천 년 동안 근본적으로 변하지 않았다. 기술은 끊임없이 변한다. 우리에게 ④적응해야 하는 것은 바로 기술이다. 이것이 바로 인간 중심 컴퓨팅 하에서 정보 기술과 그 장치들에 일어날 일이다. 컴퓨터가 우리를 마법 같은 새로운 세계로 데려다줄 것이라고 계속 믿을수록, 우리는 그것들이 우리 삶과 자연스럽게 융합되는 것을 더 오래 ⑤유지할 것이며, 이는 사회경제적 혁명이라 불릴 만한 모든 주요 운동의 특징이다.
*hype: 과대광고 **hallmark: 특징
...
- [단어장 바로 가져오기](https://scanvoca.com/wordbooks/import?code=GE78VD22)
- [공유 게시글에서 보기](https://scanvoca.com/board/share/43)

## Scan Voca와 함께라면, 고난도 어휘도 정복 가능!

수능 영어 3등급을 넘어 1, 2등급으로 도약하기 위해서는 단순히 많은 단어를 외우는 것만으로는 부족합니다. 오늘 살펴본 것처럼, 단어의 정확한 의미와 뉘앙스를 파악하고 문맥 속에서 올바르게 활용하는 능력이 필수적입니다. 하지만 방대한 양의 단어와 헷갈리는 동의어들 때문에 어디서부터 시작해야 할지 막막할 수 있습니다. Scan Voca는 사진 한 장으로 순식간에 단어장을 만들어, 언제 어디서든 꺼내 보며 외울 수 있게 해주는 영어 단어장 앱입니다.
