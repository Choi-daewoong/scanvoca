---
title: "수능 영어 2022학년도 36번: '환경세'가 쓰레기 문제를 해결하는 마법? 시장 반응 모델로 완벽 분석!"
description: "2022학년도 수능 영어 36번 문항을 통해 '환경세'와 '시장 반응 모델'의 원리를 중학생 눈높이에 맞춰 설명합니다. 자원 소비 감소와 혁신을 유도하는 환경세의 힘을 알아보고 영어 독해 실력을 키워보세요."
category: "수능·내신"
tags: ["환경세", "시장 반응 모델", "자원 효율성", "수능 영어", "독해 전략"]
date: "2026-08-08"
published: true
thumbnail: "/blog-images/environmental-tax-market-response-model-2022-suneung-36/1.png"
---
![수능 영어 2022학년도 36번: '환경세'가 쓰레기 문제를 해결하는 마법? 시장 반응 모델로 완벽 분석!](/blog-images/environmental-tax-market-response-model-2022-suneung-36/1.png)

## 까다로운 2022학년도 수능 영어 36번, 낯선 개념에 당황하셨나요?

2022학년도 수능 영어 36번 문제는 '시장 반응 모델'이라는 다소 생소한 개념을 제시하며, 특정 정책이 어떻게 경제 주체들의 행동 변화를 유도하는지 묻고 있습니다. 특히 '환경세'가 자원 소비와 혁신에 미치는 영향을 이해해야 풀 수 있었기에, 많은 학생들이 어려움을 느꼈을 텐데요. 하지만 걱정 마세요! 이 글에서는 해당 지문을 통해 '시장 반응 모델'의 원리를 쉽고 명확하게 파헤치고, 문제 해결 전략까지 함께 알아보겠습니다.

## 2022학년도 대학수학능력시험 영어영역 36번 원문 및 문제
...
시장 반응 모델(market response model)에 따르면, 공급자가 새로운 공급원을 찾도록, 혁신가가 대체재를 만들도록, 소비자가 절약하도록, 그리고 대안이 등장하도록 만드는 것은 바로 가격 상승이다.

(A) 이러한 '녹색세(green taxes)'의 사례는 많다. 예를 들어, 쓰레기 처리에 드는 매립 비용, 인건비 및 관련 비용에 직면한 일부 도시들은, 가구들이 소비자가 직접 구매해야 하며 흔히 개당 1달러 이상인 특수 쓰레기봉투에 모든 쓰레기를 버리도록 의무화했다.

(B) 특정 상품이나 서비스에 세금을 부과해 가격을 올리면, 그 자원의 사용이 줄어들거나 새로운 공급원 혹은 대안의 창의적인 혁신으로 이어져야 한다. 세금으로 걷은 돈은 정부가 서비스를 제공하거나 대안을 찾는 데 직접 사용할 수 있다.

(C) 그 결과 재활용이 크게 증가했고 소비자들은 포장과 쓰레기에 더 세심한 주의를 기울이게 되었다. 쓰레기 비용을 소비자에게 내부화함으로써, 가정에서 나오는 쓰레기 배출량이 감소하는 것이 관찰되었다.

## 유형별 문제 풀이 전략: 문단 순서 배열 문제 정복하기
...
## 정답 및 상세 해설: '환경세'와 '시장 반응 모델'의 완벽 분석
...
이처럼 '시장 반응 모델'은 특정 정책(환경세)이 가격을 통해 소비자, 생산자 등 경제 주체들의 행동 변화(자원 절약, 혁신)를 유도하는 과정을 설명하는 이론입니다. 수능 영어에서는 이처럼 경제, 사회 현상을 설명하는 다양한 모델이나 이론을 지문으로 제시하며, 그 원리를 이해하고 적용하는 능력을 평가합니다.

## Scan Voca와 함께라면 어렵지 않아요!

오늘 살펴본 '시장 반응 모델'처럼, 수능 영어 지문에는 경제, 과학, 사회 등 다양한 분야의 전문적인 내용이 등장합니다. 이런 지문들을 정확하게 이해하고 문제를 풀기 위해서는 단순히 단어 암기만으로는 부족하죠. 문맥 속에서 단어의 의미를 파악하고, 문장 구조를 분석하며, 전체적인 논리 흐름을 따라가는 능력이 중요합니다. Scan Voca는 이러한 독해력 향상을 위한 최적의 도구입니다. 복잡한 지문도 체계적으로 분석하고, 핵심 어휘와 표현을 효과적으로 학습할 수 있도록 도와주죠. 어려운 수능 지문도 결국 단어 하나하나부터 시작됩니다. Scan Voca는 사진 한 장으로 순식간에 단어장을 만들어, 언제 어디서든 꺼내 보며 외울 수 있게 해주는 영어 단어장 앱입니다.
