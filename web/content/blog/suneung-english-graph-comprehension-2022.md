---
title: "2022 수능 영어 4번 유형 정복! 도표 속 '틀린 그림 찾기' 단 5분 만에 끝내는 비법"
description: "2022학년도 수능 영어 4번 도표 문제 유형을 5분 안에 정복하는 비법을 공개합니다. 'global middle class', 'region share', 'percentage change' 핵심 키워드를 통해 정보 비교 및 추론 능력을 강화하세요."
category: "수능·내신"
tags: ["수능 영어", "도표 문제", "영어 독해", "고등 영어", "정보 비교", "추론 능력"]
date: "2026-08-05"
published: true
thumbnail: "/blog-images/suneung-english-graph-comprehension-2022/1.png"
---
![2022 수능 영어 4번 유형 정복! 도표 속 '틀린 그림 찾기' 단 5분 만에 끝내는 비법](/blog-images/suneung-english-graph-comprehension-2022/1.png)

수능 영어 영역에서 까다로운 유형 중 하나로 꼽히는 도표 정보 이해 문제. 많은 학생들이 도표를 해석하고 주어진 정보와 일치하는지 확인하는 과정에서 시간을 빼앗기거나 실수를 하곤 합니다. 아래 2022학년도 수능 영어 25번 문항을 먼저 직접 풀어본 뒤, Scan Voca가 알려드리는 공략법으로 확인해보세요.

## 먼저 풀어보세요 — 2022학년도 수능 영어 25번
...
**문제(question):** 다음 도표의 내용과 일치하지 않는 것은?
...
### 1단계: 도표의 제목과 축, 단위 확인하기 (1분)

가장 먼저 해야 할 일은 도표가 무엇을 나타내는지 파악하는 것입니다. 도표의 제목, 가로축과 세로축에 표시된 정보, 그리고 사용된 단위(퍼센트, 명수 등)를 정확히 확인하세요.

### 2단계: 선택지별 핵심 정보 추출 및 도표와 대조하기 (3분)

각 선택지에 제시된 정보를 하나씩 확인하며 도표의 해당 부분과 비교합니다. 이때, 선택지의 내용을 그대로 믿지 말고 반드시 도표의 수치와 직접 비교해야 합니다. 특히 **'증가', '감소', '유지', '이상', '미만'** 등의 표현에 주목하며 숫자 변화를 정확히 파악하는 것이 중요합니다.

### 3단계: 일치하지 않는 내용 최종 확인 및 정답 선택 (1분)

모든 선택지를 도표와 대조한 후, 도표의 내용과 명백하게 일치하지 않는 하나를 찾아내면 됩니다. 때로는 미묘한 숫자 차이로 틀린 선택지가 만들어지기도 하므로, '증가/감소/유지' 같은 서술어와 '몇 배', '이상/미만' 같은 비교 표현을 특히 꼼꼼하게 확인하는 습관이 중요합니다.

## 상세 해설 — 정답은 무엇일까?

**정답: ④**

- **선택지 ①**: 아시아 태평양 지역의 중산층 점유율은 2015년 46%에서 2025년 60%로 증가할 것으로 예상됩니다. 이는 도표상의 수치와 일치합니다.
- **선택지 ②**: 2025년 아시아 태평양 지역의 점유율(60%)은 유럽 지역의 점유율(16%)보다 약 3.75배 크므로, '세 배 이상'이라는 표현은 맞습니다. 아시아 태평양이 가장 큰 비중을 차지하는 것도 맞습니다.
- **선택지 ③**: 유럽은 24%에서 16%로, 북미는 11%에서 8%로 모두 감소하는 것으로 나타나 도표와 일치합니다.
- **선택지 ④**: 중앙 및 남아메리카 지역의 점유율은 2015년 7%에서 2025년 9%로 증가할 것으로 예상됩니다. 따라서 '변화가 없을 것'이라는 내용은 도표와 일치하지 않습니다. 이것이 정답입니다.
- **선택지 ⑤**: 2015년 중동 및 북아프리카(MENA)의 점유율은 9%, 사하라 이남 아프리카는 7%였습니다. 2025년에는 MENA가 10%, 사하라 이남 아프리카가 8%로 예상되어, MENA의 점유율이 사하라 이남 아프리카보다 여전히 높습니다. 이는 도표와 일치합니다.

## 꾸준함이 만드는 영어 실력, Scan Voca와 함께라면 어렵지 않아요!

오늘 우리는 2022학년도 수능 영어 도표 문제 유형을 어떻게 빠르고 정확하게 공략할 수 있는지 알아보았습니다. 결국, 이러한 유형별 문제 해결 능력의 기반에는 탄탄한 어휘력이 자리 잡고 있습니다. 아무리 도표를 잘 해석하는 방법을 알아도, 지문에 등장하는 생소한 단어 때문에 발목이 잡힌다면 좋은 결과를 얻기 어렵겠죠. 'global middle class', 'region share', 'percentage change'처럼 도표 문제에 자주 등장하는 표현들을 미리 정리해두면, 실전에서 도표를 훨씬 빠르게 읽어낼 수 있습니다. Scan Voca는 사진 한 장으로 순식간에 단어장을 만들어, 언제 어디서든 꺼내 보며 외울 수 있게 해주는 영어 단어장 앱입니다.
