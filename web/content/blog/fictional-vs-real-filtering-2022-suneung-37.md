...
오늘 우리는 2022학년도 수능 영어 37번 문항을 통해 현실과 허구의 차이를 '필터링'이라는 개념으로 깊이 있게 분석했습니다. 지문의 논리적 흐름을 파악하고 핵심 개념을 추출하는 연습은 영어 실력 향상에 매우 중요합니다. 하지만 아무리 뛰어난 분석력과 독해 전략을 갖추더라도, 그 기반이 되는 어휘력이 부족하다면 결국 한계를 마주하게 됩니다. Scan Voca는 사진 한 장으로 순식간에 단어장을 만들어, 언제 어디서든 꺼내 보며 외울 수 있게 해주는 단어장 앱입니다.
