---
title: "수능 영어 2022학년도 37번: 현실과 허구의 차이, '필터링' 관점으로 파헤치기!"
description: "2022학년도 수능 영어 37번 문항을 통해 현실과 허구의 차이를 '필터링' 개념으로 분석하고, 독해력과 문제 해결 능력을 향상시키는 학습 전략을 제공합니다."
category: "수능·내신"
tags: ["수능 영어", "영어 독해", "필터링", "2022학년도 수능", "비판적 사고"]
date: "2026-08-08"
published: true
thumbnail: "/blog-images/fictional-vs-real-filtering-2022-suneung-37/1.png"
---
![수능 영어 2022학년도 37번: 현실과 허구의 차이, '필터링' 관점으로 파헤치기!](/blog-images/fictional-vs-real-filtering-2022-suneung-37/1.png)

## 수능 영어 37번: 현실과 허구, 무엇이 다를까요?

수능 영어 지문을 공부하다 보면 '이게 대체 무슨 말이지?' 싶을 때가 있죠. 특히 순서 배열 문제나 문장 삽입 문제는 지문의 흐름을 정확히 파악하지 못하면 오답으로 직행하기 쉽습니다. 2022학년도 수능 영어 37번 문항 역시 이러한 유형 중 하나로, 현실 세계와 문학 속 허구 세계의 차이를 설명하며 독자의 사고력을 자극하는 지문이었습니다. 단순히 내용을 이해하는 것을 넘어, 글쓴이가 말하고자 하는 핵심 개념을 파악하고 논리적인 흐름을 따라가는 연습이 필요한 문제였는데요. 오늘은 이 지문을 통해 '필터링'이라는 키워드를 중심으로 현실과 허구의 차이를 명확히 이해하고, 이러한 분석적 독해 능력을 키워나가는 방법을 함께 알아보겠습니다.

## 2022학년도 수능 영어 37번 원문 및 문제
...
허구 세계와 현실 세계 사이의 유사성에도 불구하고, 허구 세계는 한 가지 중요한 측면에서 현실 세계와 달라진다.

(A) 작가는 중립적이고 객관적이려 하거나 세상에 대한 주관적 관점을 전달하려는 시도 속에서, 자기 자신의 세계관과 관련성에 대한 자신만의 개념에 따라 내용을 선택해왔다. 어떤 동기에서든, 작가의 주관적인 세계관은 독자와 이야기가 바탕을 둔 원본의, 손대지 않은 세계 사이에 자리한다.

(B) 개인이 유산과 환경을 통해 부여받은 내적 특성 때문에, 마음은 필터처럼 작동한다. 그 필터를 통과하는 모든 외부 인상은 걸러지고 해석된다. 하지만 독자가 문학 작품에서 마주하는 세계는 이미 또 다른 의식에 의해 처리되고 필터링된 것이다.

(C) 개인이 마주하는 기존 세계는 원칙적으로, 인간의 마음에 의해 조직화되기 전까지는 무한한 사건과 세부사항의 혼돈이다. 이 혼돈은 인간의 마음에 의해 지각될 때 비로소 처리되고 수정된다. [3점]
*deviate: 벗어나다 **endow: 부여하다 ***heritage: 유산
...
*   **(C) 문단:** 현실 세계는 인간의 마음이 조직화하기 전까지는 무질서한 혼돈 상태라는 점을 먼저 제시합니다. 즉, 우리가 세상을 인식하는 방식에 대한 근본적인 설명을 시작합니다. 현실 세계의 '원본' 상태에 대한 언급으로 볼 수 있습니다.
...
오늘 우리는 2022학년도 수능 영어 37번 문항을 통해 현실과 허구의 차이를 '필터링'이라는 개념으로 깊이 있게 분석했습니다. 지문의 논리적 흐름을 파악하고 핵심 개념을 추출하는 연습은 영어 실력 향상에 매우 중요합니다. 하지만 아무리 뛰어난 분석력과 독해 전략을 갖추더라도, 그 기반이 되는 어휘력이 부족하다면 결국 한계를 마주하게 됩니다. Scan Voca는 사진 한 장으로 순식간에 단어장을 만들어, 언제 어디서든 꺼내 보며 외울 수 있게 해주는 영어 단어장 앱입니다.
