...
## 2024 수능 영어 39번, 어디서 막히셨나요?
2024학년도 대학수학능력시험 영어영역 39번 문제는 다소 생소할 수 있는 과학 개념과 비유를 통해 수험생들의 독해력과 추론 능력을 평가했습니다. 특히 '돌연변이'와 '책의 오탈자'라는 두 가지 비유를 연결하여 하나의 논리 흐름을 파악해야 했기에, 많은 수험생들이 어려움을 느꼈을 것으로 예상됩니다. 이 글에서는 해당 지문을 통해 복잡한 과학 개념을 쉽게 이해하고, 수능 영어 문제 해결 능력을 한 단계 높이는 방법을 함께 알아보겠습니다.
...
(주어진 문장) 그러나 논증의 다음 단계에서는 이 비유가 깨진다.

책이나 어떤 글로 된 메시지의 오탈자는 대개 그 내용에 부정적인 영향을 미치며, 때로는 (문자 그대로) 치명적이기도 하다. ( ① ) 예를 들어, 쉼표 하나의 위치가 바뀌는 것이 생사를 가르는 문제가 될 수도 있다. ( ② ) 마찬가지로 대부분의 돌연변이는 그것이 발생한 유기체에 해로운 결과를 초래하는데, 이는 그 유기체의 번식 적합도를 떨어뜨린다는 의미다. ( ③ ) 하지만 가끔은 유기체의 적합도를 높이는 돌연변이가 발생하기도 하는데, 이는 마치 초판의 본문을 우연히 잘못 복제한 것이 오히려 더 정확하거나 최신의 정보를 제공하게 되는 것과 같다. ( ④ ) 유리한 돌연변이는 다음 세대에 더 많이 나타나게 되는데, 그 돌연변이가 발생한 유기체가 더 많은 자손을 남기고 돌연변이는 그 자손에게 전달되기 때문이다. ( ⑤ ) 반면에, 우연히 초판의 오류를 바로잡은 책이 더 잘 팔리게 되는 메커니즘 같은 것은 없다.
*analogy: 유사 **mutation: 돌연변이
...
이번 2024학년도 수능 영어 39번 문제처럼, 복잡한 과학 개념이나 추상적인 비유를 이해하는 것은 수능 영어 고득점을 위한 필수 관문입니다. 특히 'mutation', 'analogy', 'reproductive fitness'와 같은 어휘는 단순히 뜻만 암기하는 것을 넘어, 문맥 속에서 어떻게 사용되는지 파악하는 것이 중요합니다. Scan Voca는 이러한 수능 영어 기출 지문에 등장하는 핵심 어휘들을 효과적으로 학습할 수 있도록 돕습니다. 단순히 단어를 나열하는 것이 아니라, 실제 지문 속에서 단어가 어떻게 활용되는지 보여줌으로써 여러분의 독해력과 어휘력을 동시에 향상시킬 수 있습니다. 결국 영어 실력의 근간은 탄탄한 어휘력이 뒷받침될 때 빛을 발합니다. Scan Voca는 사진 한 장으로 순식간에 단어장을 만들어, 언제 어디서든 꺼내 보며 외울 수 있게 해주는 영어 단어장 앱입니다.
