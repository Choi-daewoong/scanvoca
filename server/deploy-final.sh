...
gcloud services enable run.googleapis.com --project=${PROJECT_ID} 2>/dev/null || echo "이미 활성화됨"
gcloud services enable containerregistry.googleapis.com --project=${PROJECT_ID} 2>/dev/null || echo "이미 활성화됨"
echo -e "✅ API 활성화 완료\n"
...
echo -e "✅ GEMINI_API_KEY: ${GEMINI_API_KEY:0:15}..."
echo -e "✅ JWT_SECRET_KEY: ${JWT_SECRET_KEY:0:15}...\n"
...
echo -e "1️⃣ 브라우저에서 Health Check 확인:"
echo -e "   ${YELLOW}${SERVICE_URL}/health${NC}\n"

echo -e "2️⃣ 앱 환경변수 업데이트:"
...
echo -e "${GREEN}✅ 서비스 URL이 deployment_url.txt에 저장되었습니다${NC}\n"
